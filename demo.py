...
def demo3():
    amplitudeFunction = s.getADSRAmplitudeFunction(attack = .05, decay = .04, sustain = .5, release = 1, attackAmp = 1, sustainAmp = .1)
    snare = s.getSignal(duration = 4, oscillator = s.whitenoise, amplitudeFunction = amplitudeFunction)
